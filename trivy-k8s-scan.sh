...
docker run --rm -v "$PWD/.trivyignore":/.trityignore:ro -v $WORKSPACE:/root/.cache/ aquasec/trivy:0.41.0 -q image --exit-code 1 --ignore-unfixed --sre-unfixed --severity CRITICAL --ignorefile /.trivyignore --light $imageName
