...
docker run --rm -v -v $PWD/.trivyignore:/.trivyignore -v $WORKSPACE:/root/.cache/ aquasec/trivy:0.17.2 -q image --exit-code 1 --ignore-unfixed --severity CRITICAL --light $imageName
