...
docker run --rm -v $WORKSPACE:/root/.cache/ aquasec/trivy:0.41.0 -q image --exit-code 1 --ignore-unfixed --severity CRITICAL --ignore-policy ignore_deps_docker_k8s.rego --light $dockerImageName
